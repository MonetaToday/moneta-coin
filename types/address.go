...
const (
	...
	Bech32MainPrefix = "moneta"

	// Purpose is the Moneta coin purpose as defined in SLIP44 (https://github.com/satoshilabs/slips/blob/master/slip-0044.md)
	Purpose = 44

	// CoinType is the Moneta coin type as defined in SLIP44 (https://github.com/satoshilabs/slips/blob/master/slip-0044.md)
	CoinType = 707

	// FullFundraiserPath is the parts of the BIP44 HD path that are fixed by
	// what we used during the Moneta coin fundraiser.
	FullFundraiserPath = "m/44'/707'/0'/0/0"
